...
# Axes geometry
f.x_range = Range1d(start=flowers["petal_length"][flowers["species"] == 'setosa'].min()-0.25,
                    end=flowers["petal_length"][flowers["species"] == 'virginica'].max()+0.25)
f.y_range = Range1d(start=flowers["petal_width"][flowers["species"] == 'setosa'].min()-0.25,
                    end=flowers["petal_width"][flowers["species"] == 'virginica'].max()+0.25)
# f.x_range = Range1d(start=2,
#                     end=8)
# f.y_range = Range1d(start=0,
#                     end=3)
