...
//myvar = "hello"
//Error:(3, 17) type mismatch;
//found   : String("hello")
//required: Int
myvar = 200

//myval = 2.5
//Error:(9, 15) reassignment to val
//myval = 2.5

val c = 12
val s = "my string"
val my_string = "Hello"
val `my.string` = "hello" //Not recommended
//val 2strings = "hello hello"
//Error:(17, 13) Invalid literal number
//val 2strings = "hello hello"

//val my.string = "hello"
//Error:(21, 13) not found: value my
//val my.string = "hello"
